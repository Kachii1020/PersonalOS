...
- **Phase 5A cron** — hosted 0014~0017과 운영 Mac E2E/푸시는 완료했다. jarvis.yml의 수동 작업도 성공했다. 실제 iPhone 검증 후 `JARVIS_CRON_ENABLED=true`로 5분 예약 실행을 활성화한다. 증거는 `docs/G5A-PRODUCTION-REPORT.md`.
