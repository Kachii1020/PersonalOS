...
- [ ] G7A-3 DB projection 60/60 및 실제 iPhone→Mac 1회 통과; 30개 실제 기기/브라우저 복원 표본은 미실행
...
- [ ] G7B-3 실제7일 정시성 ≥99% — 2026-09-09 10:20 JST 시작, 첫 3/3 hourly canary 정시·누락0·Push0; 7일 전 통과 금지
- [x] G7C-1 대화내 개별승인/결과/partial 구현, 실모델 브라우저 task 승인 및 DB 합성 partial 검사
- [x] G7C-2 고정 v2 최초22/30 + 실패 사례 deterministic5/5 = 27/30(90%); 도달한 검사에서 duplicate/미승인/거짓완료0, 나머지3 post-state 미관측 명시
