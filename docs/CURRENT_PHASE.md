**Phase 7 — 업무 맥락·업무별 알림·대화 내 개별 승인 구현 중.** 사용자 승인 계약은 `docs/PHASE7-SPEC.md`. 기존 Phase6 운영과 Learn/Quiz는 유지한다. 새 기능은 기본 OFF이며 실제7일 정시성 게이트 전에는 자동조건알림을 운영 승격하지 않는다. Phase6 PR29의 운영 배포 완료 기록은 해당 PR의 2026-09-08 배포 댓글을 따른다.
